...
# -*- coding: utf-8 -*-
#
# genparser documentation build configuration file
#
...
project = 'genparser'
copyright = '2019, anilgs@gmail.com'
...
htmlhelp_basename = 'genparserdoc'
...
latex_documents = [
    (master_doc, 'genparser.tex', 'genparser Documentation',
     'anilgs@gmail.com', 'manual'),
]
...
man_pages = [
    (master_doc, 'genparser', 'genparser Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'genparser', 'genparser Documentation',
     author, 'genparser', 'One line description of project.',
     'Miscellaneous'),
]
